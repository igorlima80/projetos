...
class StatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create state" do
    assert_difference('State.count') do
      post states_url, params: { state: { code: @state.code, country_id: @state.country_id, ibgeid: @state.ibgeid, name: @state.name } }
    end
  ...
  test "should update state" do
    patch state_url(@state), params: { state: { code: @state.code, country_id: @state.country_id, ibgeid: @state.ibgeid, name: @state.name } }
