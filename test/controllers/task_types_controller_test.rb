...
class TaskTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create task_type" do
    assert_difference('TaskType.count') do
      post task_types_url, params: { task_type: { name: @task_type.name, stage_id: @task_type.stage_id } }
    end
  ...
  test "should update task_type" do
    patch task_type_url(@task_type), params: { task_type: { name: @task_type.name, stage_id: @task_type.stage_id } }
