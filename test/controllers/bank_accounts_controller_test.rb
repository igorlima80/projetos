...
class BankAccountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bank_account" do
    assert_difference('BankAccount.count') do
      post bank_accounts_url, params: { bank_account: { agency: @bank_account.agency, bank_id: @bank_account.bank_id, number_account: @bank_account.number_account, operation: @bank_account.operation } }
    end
  ...
  test "should update bank_account" do
    patch bank_account_url(@bank_account), params: { bank_account: { agency: @bank_account.agency, bank_id: @bank_account.bank_id, number_account: @bank_account.number_account, operation: @bank_account.operation } }
